...
function Desarrollo() {
  return (
    <div>
      ...
      <h2 className="title-h2-des text-center module">
      ...
      <p className="p-des module mb-5">
        ...
        queremos estar a la vanguardia. Por eso estamos desarrollando proyectos
        novedosos, donde la mejora de procesos, la optimización del tiempo, las
        nuevas necesidades y el componente social es nuestro punto de partida.
      </p>
      <p className="p-des module mb-5">
