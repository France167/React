    ...
    <div>
      ...
      <div className="formacion-releevant module">
        <div className="formacion-divs-releevant module">
          <h3 className="h3-releevant text-center module mt-3">REVOLUCIÓN</h3>
          <h5 className="h5-releevant text-center module mt-2">FORMACIÓN DIFERENTE</h5>
          <p className="p-formacion-rel module">
            NUESTRA FORMACIÓN SE BASA EN CONTEXTOS REALES PARA QUE SALGAS
            PREPARAD@ AL ENTORNO LABORAL.
          </p>
        </div>
        <div className="formacion-divs-releevant module">
          <h3 className="h3-releevant text-center module mt-3">TRANSFORMACIÓN</h3>
          <h5 className="h5-releevant text-center module mt-2">
        ...
        <div className="formacion-divs-releevant module">
          <h3 className="h3-releevant text-center module mt-3">INNOVACIÓN</h3>
          <h5 className="h5-releevant text-center module mt-2">TALENTO & IDEAS</h5>
          <p className="p-formacion-rel module">
                    ...
                    <div className="card__collection clear-fix">
                      <div className="cards cards--two">
                        ...
                        <ul className="cards__list">
                          <li>
                          <a href={alumno.alumno.datosPersonales.LinkedIn}> <i className="fab fa-linkedin-in"></i></a>
                          </li>
                        </ul>
                      </div>
                    </div>
